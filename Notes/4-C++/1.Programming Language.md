...
public:
	int Value{};
	Number(int Number_Value):Value{Number_Value}{}
	operator Point()
	{
...
public:
	...
	Point(int X,int Y):X_Axis{X},Y_Axis{Y},Summation{new int (X+Y)}{cout<<"Constructor"<<endl;}
	~Point(){delete Summation;cout<<"Distructor"<<endl;}
	inline bool operator>(Point &P2){return (this->X_Axis+this->Y_Axis)>(P2.X_Axis+P2.Y_Axis);}
	inline bool operator<(Point &P2){return (this->X_Axis+this->Y_Axis)<(P2.X_Axis+P2.Y_Axis);}
	int X_Axis{};
	int Y_Axis{};
	int *Summation{};
...
class Point
{
	friend ostream& operator<<(ostream &Stream,Point const &Object);
...
bool operator<(Point const &P1,P
			
			oint const &P2){return (P1.X_Axis+P1.Y_Axis)<(P2.X_Axis+P2.Y_Axis);}
bool operator==(Point const &P1,Point const &P2){return (P1.X_Axis+P1.Y_Axis)==(P2.X_Axis+P2.Y_Axis);}
ostream& operator<<(ostream &Stream,Point const &Object)
{
	Stream<<'('<<Object.X_Axis<<','<<Object.Y_Axis<<')'<<"->"<<(*Object.Summation);
	return Stream;
...
    int Number_1{2};
    int Number_2{2};
    strong_ordering Result {Number_1<=>Number_2};
    cout<<(Result==0)<<endl;
    return 0;
}
///////////////// Weak Ordering /////////////////
...
    weak_ordering Result {String_1<=>String_2};
    cout<<(Result==0)<<endl;
    cout<<(Result>0)<<endl;
    cout<<(Result<0)<<endl;
    return 0;
...
{
    double Number_1{2.2};
    double Number_2{numeric_limits<double>::quiet_NaN()};
    partial_ordering Result {Number_1<=>Number_2};
    cout<<(Result==0)<<endl;
    cout<<(Result>0)<<endl;
    cout<<(Result<0)<<endl;
    return 0;
...
{
public:
	Integer(int Integer_Value):Value{Integer_Value}{}
	auto operator<=>(const Integer &Second_Operand)const
	{
		return (this->Value>Second_Operand.Value)?
		(strong_ordering::greater):(this->Value==Second_Operand.Value)?
		(strong_ordering::equivalent):(strong_ordering::less);
	}
	bool operator==(const Integer& Second_Operand) const
	{
        return Value == Second_Operand.Value;
    }
private:
	int Value{};
};
...
using namespace std;
template <typename Type_1,typename Type_2>
auto Summation(Type_1 Number_1,Type_2 Number_2)
{
    return Number_1+Number_2;
}
template<>
auto Summation<string,string>(string Number_1,string Number_2)
{
    return Number_1.size()+Number_2.size();
}
int main()
{
    cout<<Summation(string("Hello"),string("-World"))<<endl;
    return 0;
}
/////////////////////////////////////////////////////
//Variadic Template.
...
#include <iostream>
template <typename Type>
Type Division(Type Number_1,Type Number_2)
{
    if(Number_2==0){throw std::string{"Error Devide By Zero."};}
    return Number_1/Number_2;
}
int main()
{
...
auto Summation(Type_1 Number_1,Type_2 Number_2)
{
    if(typeid(Type_1)==typeid(Type_2))return Number_1+Number_2;
    else{throw;}
}
int main()
{
    std::set_terminate([]()
    {
        std::cout<<"\nApplication Should Add Same Type Operants."<<std::endl;
        std::this_thread::sleep_for(std::chrono::seconds(3));
        std::abort();
    });
    std::cout<<"- Result = "<<Summation(10.1, 11)<<std::endl;
    return 0;
}
///////////////////////////////////////////////////
